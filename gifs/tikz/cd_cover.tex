...
\newcommand{\studente}      {Matteo Ragni}
\newcommand{\corsolaurea}   {Ingegneria Meccatronica}
\newcommand{\titolotesi}    {Autonomous VTOL for avalanche buried searching \\ Avionics}
\newcommand{\relatori}      {Prof. Ing. Paolo Bosetti \\ Prof. Ing. Francesco Biral}
...
\begin{tikzpicture}
	...
	\node at (1cm, 3cm) [anchor=180,align=left] {Relatore/i:};
