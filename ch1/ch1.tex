...
\begin{itemize}
\item 50\% of the accidents have only one buried 
...
\begin{marginfigure}
	...
	\filldraw[fill=gray!30, draw=black] (pointA1) -- (pointA2) arc (0-90:124.1-90:15mm) -- cycle;
	\filldraw[fill=white, draw=black] (pointB1) -- (pointB2) arc (124.1-90:180-91.5:15mm) -- cycle;
	\filldraw[fill=gray!70, draw=black] (pointC1) -- (pointC2) arc (180-90:360-90:15.5mm) -- cycle;
